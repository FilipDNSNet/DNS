...
alter table adressen.dv_adressen_brandenburg add column verifizierungstyp text;
alter table adressen.dv_adressen_brandenburg add column analysiert_durch text;
alter table adressen.dv_adressen_brandenburg add column foerder_status text;
alter table adressen.dv_adressen_brandenburg add column beschreibung text;
--constraints
alter table adressen.dv_adressen_brandenburg add constraint fk_adresse_brandenburg_verifizierungstyp foreign key (verifizierungstyp)
	references enum_adressen_verifizierungstyp(val) on update cascade;
alter table adressen.dv_adressen_brandenburg add constraint fk_adresse_brandenburg_analysiert_durch foreign key (analysiert_durch)
