...
--	                                                                                                                                                              --  
--	                                                                                                                                                              --  
--	name:		tr_dv_adressen_berlin_before_update                                                                                                               --     
--	schema:		public                                                                                                                                            --  
--	typ:		Trigger                                                                                                                                           --     
--	cr.date:	02.12.2020                                                                                                                                        --  
--	ed.date:	03.12.2020                                                                                                                                        --  
...
--	purpose: 	                                                                                                                                                  --  
--				Before update on "adressen.dv_adressen_berlin"                                                      			                                  --                                                                                                             
--	DNS-Net GIS group                                                                                                                                             --  
--*/----------------------------------------------------------------------------------------------------------------------------------------------------------------



create or replace function tr_dv_adressen_berlin_before_update() returns trigger as $$
DECLARE
	t boolean;
BEGIN
	select case 
...
drop trigger  if  exists tr_dv_adressen_berlin_before_update on adressen.dv_adressen_berlin;

CREATE TRIGGER tr_dv_adressen_berlin_before_update
	BEFORE UPDATE ON adressen.dv_adressen_berlin
		FOR EACH ROW
			EXECUTE PROCEDURE tr_dv_adressen_berlin_before_update();
