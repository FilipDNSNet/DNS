...
--	                                                                                                                                                              --  
--	                                                                                                                                                              --  
--	name:		tr_dv_adressen_sachsen_anhalt_before_update                                                                                                       --             
--	schema:		public                                                                                                                                            --  
--	typ:		Trigger                                                                                                                                           --     
--	cr.date:	02.12.2020                                                                                                                                        --  
--	ed.date:	03.12.2020                                                                                                                                        --  
...
create or replace function tr_dv_adressen_sachsen_anhalt_before_update() returns trigger as $$
DECLARE
	t boolean;
BEGIN
	select case 
	...
	if (t) Then
		...
		UPDATE adressen._geometry_adresse_25832 set geom=new.geom where adressen._geometry_adresse_25832._id=new._id;
		RETURN NULL;
	else
		RETURN NULL;
	End if;
...
CREATE TRIGGER tr_dv_adressen_sachsen_anhalt_before_update
	BEFORE UPDATE ON adressen.dv_adressen_sachsen_anhalt
		FOR EACH ROW
			EXECUTE PROCEDURE tr_dv_adressen_sachsen_anhalt_before_update();
