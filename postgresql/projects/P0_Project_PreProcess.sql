...
--Eichwalde--  ---- Create Schema if does not exists
--Eichwalde--  create schema if not exists prj_test_eichwalde;

--Eichwalde--  ----sample feeding   _cluster
--Eichwalde--  INSERT INTO _cluster(id,cluster_name, project_name, cluster_parent, onb_onkz, gemeindeschluessel, zubringerpunkt, version, beschreibung, crs_epsg, schema_name)
--Eichwalde--  	values(0,'eichwalde_pop_01', '#296_2020', Null, '33762','{12061112}', 'P01','v_01', 'FTTx Test in Eichwalde', '25833',null);
--Eichwalde--  INSERT INTO _cluster(id,cluster_name, project_name, cluster_parent, onb_onkz, gemeindeschluessel, zubringerpunkt, version, beschreibung, crs_epsg, schema_name)
--Eichwalde--  	values(1,'eichwalde_pop_01/teil_1', '#423_2020', 0, '33762','{12061112}', 'P01', 'v_01', 'Sub-pojekt', '25833', 'prj_test_eichwalde');
