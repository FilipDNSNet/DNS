...
---- Knoten
INSERT INTO prj_test_zeuthen.knoten (id, bez, geom, typ, subtyp, planung_status, foerdert_status, produkt_id, label_prefix, label_wert,cluster)
	select 
...
---- Abschlusspunkte
INSERT INTO prj_test_zeuthen.abschlusspunkte (id,geom,knoten_id,typ,einbauort,homeconnect_status,cluster)
	select 
...
-- ---- adresse_abschluss
-- INSERT INTO prj_test_zeuthen.adresse_abschluss (adresse_id, abschlusspunkte_id, cluster)
-- 	select 
-- 		adresse_id,abschlusspunkte_uuid,cluster
-- 	from comsof.adresse_abschluss;	

---- Connection_module
INSERT INTO prj_test_zeuthen.connection_module (id,typ,produkt_id,knoten_id,netzebene_quelle,netzebene_ziel,eigentum_status,foerdert_status, planung_status,cluster)
	select 
...
---- connection_unit
INSERT INTO prj_test_zeuthen.connection_unit(id,conn_module_id,produkt_id,letzten_datum_mod,cluster)
	select 
	uuid,conn_module_uuid,produkt_id,letzten_datum_mod,cluster
	from comsof.connection_unit;	

---- Connection_element
INSERT INTO prj_test_zeuthen.connection_element(id,conn_unit_id,produkt_id,typ,subtyp,installation_ziele,installation_spalte,label,mehrdetail,cluster)
	select 
...
---- Kabel
INSERT INTO prj_test_zeuthen.kabel (id,bez,geom,produkt_id, anzahl_fasern,typ,netzebene,conn_module_anfang,conn_module_ende,planung_status,foerdert_status,eigentum_status,homeconnect_status,length,cluster)
	select 
...
---- Faser
INSERT INTO prj_test_zeuthen.faser (id , bez,geom,kabel_id,netzebene, buendeln_nr,faser_label,conn_element_anfang,anf_elem_output_nr,anfang_typ,anfang_label,conn_element_ende,end_elem_input_nr,ende_typ,ende_label,length,external_id,cluster)
	select 
...
---- Rohr
INSERT INTO prj_test_zeuthen.rohr (id,bez,geom,typ,produkt_id, anzahl_microducts,mantel_farbe,mantel_label,planung_status,foerdert_status,netzebene,homeconnect_status,cluster)
	select 
...
---- Microduct
INSERT INTO prj_test_zeuthen.microduct(id,bez,geom,rohr_id,microduct_nr,knoten_anfang,   conn_module_anfang, conn_module_anfang_label,knoten_ende ,conn_module_ende, conn_module_ende_label,stammt_von, bottom_agg_id, zweig, kabel_id,netzebene, bez_wert,cluster) 
	select 
...
---- Trasse
INSERT INTO prj_test_zeuthen.trasse(id,geom,typ,trassenbauverfahren,sonst_bauverfahren,verlege_tief_m,oberflaeche,widmung,foerdert_status,planung_status,homeconnect_status,netzebene,cluster)
	select 
...
---- Schutzrohr
INSERT INTO prj_test_zeuthen.schutzrohr (id,geom,produkt_id,foerdert_status,planung_status,aggregation_id,cluster)
	select 
		uuid,geom,produkt_id,foerdert_status,planung_status,aggregation_id,cluster
	from comsof.schutzrohr;	
	
---- rohr_schutzrohr
INSERT INTO prj_test_zeuthen.rohr_schutzrohr (schutzrohr_id,rohr_id,cluster)
	select 
		schutzrohr_uuid,rohr_uuid,cluster
	from comsof.rohr_schutzrohr;
	
---- strecke
INSERT INTO prj_test_zeuthen.strecke (_id,typ,cluster)
	select 
		_uuid,typ,cluster
	from comsof.strecke;	
