...
update comsof.knoten set label_prefix='H3337/'||sel.knot_source_label_wert from (
...
update comsof.rohr set mantel_farbe='gn' where typ='Rohrverband' and anzahl_microducts in (4,12,24);
