...
---- Feeding Metadata
insert into comsof.comsof_metadata( datum, bundesland, _epsg_code, destination_cluster, beschreibung) values ( (select Now()), 'Brandenburg', '25833', Null, 'Test_Eichwalde');
