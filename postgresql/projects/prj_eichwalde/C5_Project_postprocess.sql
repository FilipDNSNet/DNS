...
update prj_test_eichwalde.knoten set produkt_id = 'FTTH Abschlußbox AP (unbestückt) Typ M' where subtyp = 'Abschlusspunkt';
update prj_test_eichwalde.connection_module set produkt_id = 'FTTH Abschlußbox AP (unbestückt) Typ M' where netzebene_ziel = 'In-House-Ebene' ;
update prj_test_eichwalde.connection_unit set produkt_id = 'FTTH Abschlußbox AP (unbestückt) Typ M' where conn_module_id in (select id from prj_test_eichwalde.connection_module where produkt_id = 'FTTH Abschlußbox AP (unbestückt) Typ M') ;
update prj_test_eichwalde.connection_element set produkt_id = 'FTTH Abschlußbox AP (unbestückt) Typ M' where conn_unit_id in (select id from prj_test_eichwalde.connection_unit where produkt_id = 'FTTH Abschlußbox AP (unbestückt) Typ M') ;
